...
\subsection*{3.2 Evaluation and model selection}
...
\subsection*{4.2 Shutdown Response gradient direction}
...
\caption{Figure 1. Shutdown detector F1 on the same validation and held-out cases. The fitting and model-selection chronology is described in Section 3.2.}
\end{figure}
...
\begin{figure}[t]
\centering
\includegraphics[width=\linewidth]{figures/shutdown_response_flip_tradeoff.png}
\caption{Figure 5. Shutdown Response-vector preferred-label flips while steering toward STOP. Counts refer to correlated answer-order views on TRAIN, not independent test cases.}
\end{figure}
