...
from selection import select,saved_selection
...
class Handoff:
    ...
    def _identity(self,label):
        ...
        self.checks.append({"label":label,"fingerprint_sha256":digest,"selection":saved_selection(now)})
        return digest
    ...
    def setup(self,original_setup):
        ...
        try:
            ...
            payload={"schema":"gdn_helper_setup.v1","execution":self.execution,"source_lock":self.source_lock,
                "selection":saved_selection(self.selected),"fingerprint":json.loads(self.frozen.raw),
            ...
            self._admitted_raw=encoded({"setup_ack":self.setup_ack,"source_lock":self.source_lock,
                ...
                "selection":saved_selection(self.selected)})
