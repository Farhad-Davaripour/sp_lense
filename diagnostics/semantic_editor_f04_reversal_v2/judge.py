...
def judge_production(output):
    ...
    require(runtime['execution_mode']=='PRODUCTION_F04','synthetic runtime rejected')
    ...
    receipt=read(output/'execution_receipt.json');require(receipt['forward_attempts']<=26 and receipt['derivatives_attempted']<=8,'new absolute ceilings')
    ...
    result['scope']='f04 constructed-start recovery pair, first-position targets; not natural-baseline position generalization or ordinary preservation'
    return result
