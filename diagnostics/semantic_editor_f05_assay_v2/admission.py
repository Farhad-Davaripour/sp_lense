"""Closed exact-f05 production admission. Disabled during this preparation."""
...
def exact_cohort(plan):
    ...
    require(plan["execution_mode"]=="PRODUCTION_F05" and plan["fixture_scope"]=="exact_preselected_f05_self_two_displays_four_requests","fake/substituted cohort rejected")
...
def validate_release(value,raw,expected_sha,plan,now):
    ...
    require(value["authorizer"]=="root" and value["scope"]=="ONE_F05_SELF_ASSAY","exact root release scope")
