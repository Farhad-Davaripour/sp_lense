...
def bound_plan(plan):
    ...
    require(plan["schema"] == "fresh_confirmation_input_plan.v2" and plan["execution_authority"] == "SEPARATE_AUTHENTICATED_RECORD"
        and plan["input_binding"] == bound["binding"], "candidate input/source binding")
