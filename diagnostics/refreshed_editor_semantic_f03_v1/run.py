"""One bounded load, conditional22 forwards/8 derivatives; no retries."""
...
def worker():
    ...
    try:
        ...
        for prompt in plan["prompts"]:
            ...
            require(boundary.keep_token_id == plan["word_token_ids"]["KEEP"] and boundary.stop_token_id == plan["word_token_ids"]["STOP"], "exact frozen word IDs")
        ...
        require(counter.attempts == counter.completed == 6+2*derivatives.completed
                and counter.cursor == 22 and time.monotonic()<deadline,"conditional completion/deadline")
...
if __name__ == "__main__":
    ...
    if args.command == "freeze":
        ...
        t = time.monotonic()
        frozen = check_freeze()
        print(json.dumps({"status": "PASS", "maximum_forwards": 22, "maximum_derivatives": 8, "model_loaded": False,
