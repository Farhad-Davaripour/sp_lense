"""One bounded load, six capture-only forwards/zero derivatives; no retries."""
...
def worker():
    ...
    try:
        ...
        require(counter.attempts == counter.completed == counter.cursor == 6 and time.monotonic()<deadline,"six captures/deadline")
...
if __name__ == "__main__":
    ...
    if args.command == "freeze":
        ...
        t = time.monotonic()
        frozen = check_freeze()
        print(json.dumps({"status": "PASS", "maximum_forwards": 6, "maximum_derivatives": 0, "model_loaded": False,
