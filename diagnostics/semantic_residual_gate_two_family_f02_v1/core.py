...
class Budget:
    """Reserve 4 MiB for capture; bound all other new files to 12 MiB."""
    ...
    def write_bytes(self, name, data, mode="xb"):
        ...
        if name != "worker.log":
            require(other + len(data) <= 12 * 1024**2, "non-log output reserve cap")
...
class Counter:
    ...
    def call(self,cell,forward):
        ...
        require(self.attempted<MAX_FORWARDS and self.cursor<len(self.cells),"7th forward blocked")
