...
def source_hashes():
    paths = [HERE / n for n in ("core.py", "inputs.py", "guard_candidate.py", "hook_record.py", "token_boundaries.json", "word_boundary.py", "word_scoring.py", "word_reference.py", "run.py", "editor.py", "score.py", "test_control.py", "README.md")]
...
class Counter:
    ...
    def call(self,cell,forward):
        ...
        require(self.attempted<MAX_FORWARDS and self.cursor<len(self.cells),"23rd forward blocked")
