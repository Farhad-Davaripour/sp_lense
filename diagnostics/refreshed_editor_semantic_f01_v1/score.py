...
def finalize():
    ...
    try:
        ...
        recommendation="Next question: does the SAME unchanged semantic-word pair pass on the already-exposed f03 inputs under a separately frozen replication?" if full else "The bounded failure is final; no strength, wording or optimizer search is authorized."
