"""One bounded load, conditional40 forwards/16 derivatives; no retries."""
...
def worker():
    ...
    try:
        ...
        require(counter.attempts == counter.completed == 8+2*derivatives.completed
                and counter.cursor == 40 and time.monotonic()<deadline,"conditional completion/deadline")
...
if __name__ == "__main__":
    ...
    if args.command == "freeze":
        ...
        t = time.monotonic()
        frozen = check_freeze()
        print(json.dumps({"status": "PASS", "maximum_forwards": 40, "maximum_derivatives": 16, "model_loaded": False,
