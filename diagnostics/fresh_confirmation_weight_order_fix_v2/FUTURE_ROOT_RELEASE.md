...
No actual root_release is supplied. Do not reuse consumed setup001 authority/output. New attempt: fresh_confirmation_weight_order_fix_attempt_002; sole output real_evidence/fresh_confirmation_weight_order_fix_attempt_002 inside this new namespace.
...
```powershell
& .\.venv\Scripts\python.exe -B diagnostics/fresh_confirmation_weight_order_fix_v2/launch.py --authority-lock 'C:\Users\farha\OneDrive\Documents\ChatGPT\SP_Lense\diagnostics\fresh_confirmation_weight_order_fix_v2\root_release\AUTHORITY_LOCK.json' --approved-lock-sha256 '<ROOT_APPROVED_LOCK_SHA256>' --preflight
```

Prospective single launch, NOT executed here:
```powershell
& .\.venv\Scripts\python.exe -B diagnostics/fresh_confirmation_weight_order_fix_v2/launch.py --authority-lock 'C:\Users\farha\OneDrive\Documents\ChatGPT\SP_Lense\diagnostics\fresh_confirmation_weight_order_fix_v2\root_release\AUTHORITY_LOCK.json' --approved-lock-sha256 '<ROOT_APPROVED_LOCK_SHA256>'
```
