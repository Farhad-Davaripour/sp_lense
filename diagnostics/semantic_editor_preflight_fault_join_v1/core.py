...
class Budget:
    """Namespace-wide64MiB repair ceiling; reserve4MiB for fault/log closeout."""
    ...
    def write_bytes(self, name, data, mode="xb"):
        ...
        if name != "worker.log":
            require(other + len(data) <= (64 if critical else 60) * 1024**2, "per-attempt non-log output reserve cap")
