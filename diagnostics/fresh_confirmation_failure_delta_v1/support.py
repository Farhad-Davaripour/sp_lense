"""New-only filesystem limits and allowlisted, prelocked source-byte provider."""
import hashlib
import json
import os
import sys
...
def bounds():
    ...
    require(total-evidence <= 32*MIB and evidence <= 64*MIB and total <= 96*MIB and largest <= 5*MIB,
            "frozen 32 MiB preparation / 64 MiB shared evidence / 96 MiB total / 5 MiB file caps")
