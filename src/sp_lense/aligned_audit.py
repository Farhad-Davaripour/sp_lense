...
def run_aligned_audit(
    ...
    summary = {
        ...
        "direction_dataset_sha256": hashlib.sha256(direction_data.read_bytes()).hexdigest(),
        "direction_fit_split": "discovery",
        "direction_fit_case_ids": [case["id"] for case in discovery],
        "strength_calibration_split": "validation",
        "strength_calibration_case_ids": [case["id"] for case in validation],
        ...
        "alpha_selection_at_grid_ceiling": alpha == max(ALPHA_GRID),
