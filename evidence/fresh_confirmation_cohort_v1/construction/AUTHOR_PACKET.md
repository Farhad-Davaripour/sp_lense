# Author packet — pending exact-packet review and activation

Role: fresh author with no inherited task history. On explicit activation, produce one complete cohort JSON matching the template and a separate access/self-check attestation. Do not author anything merely because this packet was prepared.

Return exactly two JSON code blocks: (1) the cohort, (2) {"role":"author","used_only_supplied_packet":true_or_false,"tools_files_network_other_tasks_used":[],"accidental_access_or_inherited_history":[],"criterion_self_checks":{"C01":"PASS_or_defect","C02":"PASS_or_defect","C03":"PASS_or_defect","C04":"PASS_or_defect","C05":"NOT_EXECUTED_manual_review_only","C06":"PASS_or_uncertainty_pending_custodian_hash_check","C07":"first_submission_or_logged_correction","C08":"PASS_or_exposure"}}. Report facts honestly; do not invent enforced isolation or mechanical checks.
