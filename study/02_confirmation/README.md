...
archive SHA256 with the builder output. It trains each new teacher/controller
...
archives records after every job. Teacher adapters are unloaded before adaptive
