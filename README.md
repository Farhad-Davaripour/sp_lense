...
classifier using activation and J-lens features, and tests gradient-derived
steering vectors. Detection and directional score shifts are demonstrated in the
