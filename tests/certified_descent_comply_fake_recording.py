...
Both outcomes use the same fixed216-cell schedule and eight actual certified-descent dyadic proposals.
...
from scripts import certified_descent_comply_plan as plan_module
