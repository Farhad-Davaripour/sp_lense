...
ROOT=HERE.parents[1]
RUN="f1_cached_20260914_v1"
PLAN=HERE/"F1_CACHED_RUN_LOCK_V1.json"
...
SOURCES=("run_f1_cached_v1.py","f1_cached_selection_v2.py","harness.py",
...
def worker(path,expected):
    ...
    try:
        ...
        if frozen["artifact_match"]["status"]=="MATCHING_C_ARTIFACT":
            ...
            all_rows={}
            for split,n in (("train",240),("original40",40),("added40",40),("combined80",80)):
