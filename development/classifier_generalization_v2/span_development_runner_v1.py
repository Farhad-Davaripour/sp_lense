...
Scope
-----
* One new finite lock schema ``span_development_execution.v1``:
...
import tokenizer_input_adapter as tokens
...
JOB_ID = "span_runner_implementation_20260914_1059"
SCHEMA = "span_development_execution.v1"
INDEX_SCHEMA = "span_capture_index.v1"
RECEIPT_SCHEMA = "span_capture_receipt.v1"
BINARY_SCHEMA = "span_capture_windows.v1"
STUDY = runner.STUDY
...
INPUT_ROLES = ("blueprint", "model_metadata", "snapshot_lock")
