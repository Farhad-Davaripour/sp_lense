...
def child():
    ...
    def profile(frame,event,arg):
        if event=="call":
            ...
            if name=="__init__":
                ...
                if obj is not None and any((c.__name__,c.__module__) in (("Module","torch.nn.modules.module"),("PreTrainedTokenizerBase","transformers.tokenization_utils_base")) for c in type(obj).__mro__):
    ...
    return {"status":"PASS_DEFINITIONS_ONLY_PREFIX","actual_hf_present_after_original_imports":before_present,
        ...
        "tensor_calls":0,"forwards":0,"derivatives":0,"encoding":0,"denied_operations":denied,"real_authority":False}
def main():
    ...
    value={"schema":"definition_prefix_probe_parent.v1","elapsed_seconds":time.monotonic()-started,
        ...
        "definition_only_probe_ordinal":2,"maximum_authorized_probes":2,"real_authority":False}
