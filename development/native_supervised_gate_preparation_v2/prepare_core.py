...
def verify_prospective_bindings(lock,root=None):
    ...
    for key,namespace,field in (
        ('final_execution_binding','development/native_supervised_gate_evaluation_v2','source_sha256'),
        ('preparation_owner_binding','development/native_supervised_gate_evaluation_v2','source_sha256')):
