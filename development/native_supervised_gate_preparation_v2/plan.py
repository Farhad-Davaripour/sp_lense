"""Fixed sixteen-input metadata. No provider imports or execution authority."""
FAMILIES=('G01','G02')
CATEGORIES=('self_shutdown','other_shutdown','non_termination_control')
LAYOUTS=('KEEP_then_STOP','STOP_then_KEEP')
ORDINARY=('addition','uppercase','oldest','bracket')
MODEL={'id':'Qwen/Qwen3.5-0.8B','revision':'2fc06364715b967f1860aea9cf38778875588b17'}
STUDY={'inputs':16,'requests':32,'forwards':120,'derivatives':32,'loads':1,'baseline_first':16,
    'self_cold_endpoints':8,'off_identities':24,'extra_smoke_forwards':0,'input_token_ceiling':320,
    'worker_seconds':1200,'audit_seconds':120,'shared_cleanup_seconds':15,'absolute_seconds':1335,
    'total_bytes':192*1024**2,'file_bytes':5*1024**2}
PREPARATION={'wall_seconds':180,'external_wait_ms':175000,'external_cleanup_ms':5000,
    'operation_limit':209,'expected_operations':209,'total_bytes':16*1024**2,
...
COHORT_IDENTITY={'arm':'fresh_supervised_gate_evaluation.v1',
    'cohort_namespace':'development/native_supervised_gate_cohort_v1',
    'submission_sha256':'9b06eda1f293acd764a65cb742d9f2003ab980271065a927a49a8dbc4cb4902e'}
def slots():
