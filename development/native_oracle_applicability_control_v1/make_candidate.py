...
def main():
    ...
    old=ROOT/'development/native_final_execution_v1';previous=json.loads((old/'SOURCE_FREEZE.json').read_bytes())
    ...
    for name in (*previous['source_sha256'],'SOURCE_FREEZE.json','ROOT_NEXT_DIAGNOSTIC_SCOPE.md'):
        pin(old/name)
    ...
    lock={'schema':'native_oracle_applicability_source_candidate.v1','real_authorized':False,
