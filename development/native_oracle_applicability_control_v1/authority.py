...
LIMITS={'loads':1,'forwards':21,'derivatives':8,'encoding':0,'worker_seconds':600,'audit_seconds':60,'shared_cleanup_seconds':15,'total_bytes':32*1024**2,'file_bytes':5*1024**2}
...
def read_release(approved):
    ...
    require(release['schema']=='native_oracle_applicability_release.v1' and release['approved'] is True
