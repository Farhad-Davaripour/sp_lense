...
ATTEMPT='native_supervised_gate_evaluation_v2_attempt_001'
def require(ok,code):
...
GROUP_CAPS={'logits':120*248320*4,'rows':120*128*1024,'traces':152*16*1024,'steps':32*32*1024,
...
def write_new(name,value,*,raw=False,critical=False):
    ...
    require(used+len(data)<=192*MIB-(0 if critical else 65536),'OUTPUT_CAP_CLOSEOUT_RESERVE')
