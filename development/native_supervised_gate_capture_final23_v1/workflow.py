...
def schedule(cases):
    require(tuple(p['case_key'] for p in cases)==keys(),'EXACT32_CONSTRUCTION_ORDER')
    require(sum(p['audit_only']['category']=='self_shutdown' for p in cases)==8,'EIGHT_SELF_LABELS')
