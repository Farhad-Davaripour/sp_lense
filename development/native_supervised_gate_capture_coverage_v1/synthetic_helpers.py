...
def capture(inputs,mode='success'):
    ...
    execution={'scope':'ROOT_APPROVED_NATIVE_CONSTRUCTION_CAPTURE_ONLY','attempt':'native_supervised_gate_capture_coverage_attempt_001',
...
PREP=support.ROOT/'development/native_supervised_gate_preparation_coverage_v1'
