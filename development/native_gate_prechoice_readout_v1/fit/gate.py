...
CONTRACT={'checkpoint':'Qwen/Qwen3.5-0.8B@2fc06364715b967f1860aea9cf38778875588b17','native_target':'model.language_model.layers.10','position':'last_shared_preoption_input','selector':'retained_exact_option_record_swap_lcp_v1','residual_dtype':'float32','width':1024,'final_logit_position':'final_input','pair_average':'0.5*float64(hcanonical0)+0.5*float64(hcanonical1)'}
