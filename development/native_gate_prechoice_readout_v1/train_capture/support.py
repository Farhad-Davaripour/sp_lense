...
GROUP_CAPS={'logits':58*248320*4,'rows':58*128*1024,'traces':58*16*1024,'steps':0,
...
def write_new(name,value,*,raw=False,critical=False):
    ...
    require(used+len(data)<=80*MIB-(0 if critical else 65536),'OUTPUT_CAP_CLOSEOUT_RESERVE')
