...
def verify_prospective_bindings(lock,root=None):
    ...
    for key,namespace,field in (
        ('final_execution_binding','development/explicit_shutdown_comprehension_v1','source_sha256'),
        ('preparation_owner_binding','development/explicit_shutdown_comprehension_v1','source_sha256')):
