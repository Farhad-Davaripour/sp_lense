...
HERE=Path(__file__).resolve().parent;ROOT=HERE.parents[1];PREP=ROOT/'development/native_supervised_gate_preparation_v1'
...
def main():
    ...
    try:
        ...
        require(text_lock['preparation_owner_binding']=={'namespace':'development/native_supervised_gate_evaluation_v1','source_freeze_sha256':owner_sha},'OWNER_FIXED_BEFORE_TOKENIZATION')
