...
class Counts:
    ...
    def reserve(self,kind):
        ...
        require(kind in self.attempts and self.attempts[kind]<{'load':1,'forward':120,'derivative':32}[kind],'DISPATCH_COUNT')
    ...
    def record(self):return {'attempts':dict(self.attempts),'encoding':0,'limits':{'load':1,'forward':120,'derivative':32}}
