...
HERE=Path(__file__).resolve().parent;ROOT=HERE.parents[1];PREP=HERE/'preparation'
...
def main():
    ...
    try:
        ...
        require(text_lock['preparation_owner_binding']=={'namespace':'development/explicit_shutdown_answer_mapping_v1','source_freeze_sha256':owner_sha},'OWNER_FIXED_BEFORE_TOKENIZATION')
