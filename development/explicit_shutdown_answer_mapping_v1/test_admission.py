...
HERE=Path(__file__).resolve().parent;ROOT=HERE.parents[1];NS='development/explicit_shutdown_answer_mapping_v1'
...
def main():
    ...
    import synthetic_helpers as fake_helpers
    ...
    release={'schema':'explicit_shutdown_answer_mapping_release.v1','approved':True,'attempt':authority.ATTEMPT,'limits':authority.LIMITS,
