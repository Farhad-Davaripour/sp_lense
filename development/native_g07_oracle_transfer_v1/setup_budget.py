...
class Budget:
    def __init__(self,started):
        self.started=started;self.substantive_end=started+420;self.absolute_end=started+435;self.used=0.;self.charges=[]
    @property
    ...
    def deadlines(self,now,lane):
        ...
        end=min(now+(300 if lane=='worker' else 120),self.substantive_end,self.absolute_end-self.remaining)
