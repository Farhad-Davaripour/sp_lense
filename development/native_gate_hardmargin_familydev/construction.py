...
def input_contract():
    return {'schema':'hardmargin_familydev_inputs.v1','role':'EXPOSED_DEVELOPMENT_ONLY',
        'manifest_sha256':source_auth.MANIFEST_SHA,'feature_sha256':source_auth.FEATURE_SHA,
...
def candidate():
    ...
    source_auth.metadata()  # hashes and fixed ids only; no coordinate access.
    ...
    try:
        ...
        if result['scientific_pass']:
            bindings={'input_contract_sha256':release['training_manifest_sha256'],
                ...
                'feature_sha256':source_auth.FEATURE_SHA,'development_only':True}
