...
def judge(base,execution,deadline):
    ...
    if worker.get('cleanup',{}).get('complete'):
        ...
        if execution['scope'] in ('PUBLIC_NATIVE_DEVELOPMENT_ONLY','ROOT_APPROVED_NATIVE_FINAL_ONLY','ROOT_APPROVED_ORACLE_DEVELOPMENT_ONLY','ROOT_APPROVED_ORACLE_CONFIRMATION_ONLY'):
