"""Fixed 12-row training metadata; no provider imports or execution authority."""
import re
FAMILIES=('G07',)
...
STUDY={'inputs':6,'requests':0,'forwards':6,'derivatives':0,'loads':1,
...
PREPARATION={'wall_seconds':355,'external_wait_ms':350000,'external_cleanup_ms':5000,
    'operation_limit':79,'expected_operations':79,'total_bytes':32*1024**2,
...
COHORT_IDENTITY={'arm':'native_frozen_scorer_g07_diagnostic.v1',
    'cohort_namespace':'development/native_gate_frozen_score_g07_v1'}
