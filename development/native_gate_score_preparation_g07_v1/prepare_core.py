...
def verify_prospective_bindings(lock,root=None):
    ...
    for key,namespace,field in (
        ('final_execution_binding','development/native_gate_score_capture_g07_v1','source_sha256'),
        ('preparation_owner_binding','development/native_gate_score_capture_g07_v1','source_sha256')):
