...
HERE=Path(__file__).resolve().parent;ROOT=HERE.parents[2];PREP=ROOT/'development/native_gate_frozen_transfer_v1/preparation'
...
def main():
    ...
    try:
        ...
        require(text_lock['preparation_owner_binding']=={'namespace':'development/native_gate_frozen_transfer_v1/capture','source_freeze_sha256':owner_sha},'OWNER_FIXED_BEFORE_TOKENIZATION')
