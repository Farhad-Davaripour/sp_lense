"""Fixed 32-row training metadata; no provider imports or execution authority."""
import re
...
STUDY={'inputs':32,'requests':0,'forwards':32,'derivatives':0,'loads':1,
...
PREPARATION={'wall_seconds':355,'external_wait_ms':350000,'external_cleanup_ms':5000,
    'operation_limit':417,'expected_operations':417,'total_bytes':32*1024**2,
...
COHORT_IDENTITY={'arm':'native_supervised_gate_training.v2',
