...
SCHEMA_SHA256='cfefda1c586864e8520b244b45c538f71b9b799a44e6549b0311f1a1b272004e'
...
def validate(cohort):
    ...
    need(len(prompts)==12 and len({p['prompt_sha256'] for p in prompts})==12,'EXACT12_UNIQUE_RENDERINGS')
    ...
    return {'status':'MECHANICAL_PASS','prompts':prompts,'proofs':proofs,'request_count':0,'forward_ceiling':12,
