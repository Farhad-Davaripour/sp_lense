...
def main():
    ...
    names=[p.name for p in HERE.glob('*.py')]+['inputs.json','CHECKPOINT.json','REUSED_SOURCES.json','OWNED_IDENTITY.json','PROTOCOL.md']
    ...
    reports=[]
    for name in ('TEST_RECEIVER_RESULT.json','TEST_WORKFLOW_RESULT.json','TEST_BOUNDARIES_RESULT.json'):
