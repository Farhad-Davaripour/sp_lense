...
ATTEMPT='native_development_baseline_attempt_001'
def require(ok,code):
...
GROUP_CAPS={'logits':28*248320*4,'rows':28*128*1024,'traces':36*16*1024,'steps':8*32*1024,
    'loader':256*1024,'owned':512*1024,'other':256*1024}
...
def write_new(name,value,*,raw=False,critical=False):
    ...
    require(used+len(data)<=32*MIB-(0 if critical else 65536),'OUTPUT_CAP_CLOSEOUT_RESERVE')
