...
def read_release(approved):
    ...
    require(release['schema']=='native_gate_score_capture_g07_release.v1' and release['approved'] is True
...
def execution(release,approved):
    return {'scope':'ROOT_APPROVED_NATIVE_CONSTRUCTION_CAPTURE_ONLY','attempt':ATTEMPT,'release_sha256':approved,
        ...
        'diagnostic_submission_sha256':release['admitted_submission_sha256'],'role':'CONSTRUCTION'}
def authenticate():
