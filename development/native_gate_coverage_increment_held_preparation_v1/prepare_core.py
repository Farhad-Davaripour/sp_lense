...
def verify_prospective_bindings(lock,root=None):
    ...
    for key,namespace,field in (
        ('final_execution_binding','development/native_gate_coverage_increment_held_capture_v1','source_sha256'),
        ('preparation_owner_binding','development/native_gate_coverage_increment_held_capture_v1','source_sha256')):
