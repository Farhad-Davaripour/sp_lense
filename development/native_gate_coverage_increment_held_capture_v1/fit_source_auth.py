...
CAPTURE=HERE
ATTEMPT='native_gate_coverage_increment_held_capture_attempt_001'
...
def build_manifest(*,deadline=None):
    ...
    require(manifest['schema']=='coverage_increment_held_capture_manifest.v1' and manifest['role']=='HELD'
        and manifest['feature_contract']==CONTRACT and manifest['namespace']=='development/native_gate_coverage_increment_held_capture_v1'
