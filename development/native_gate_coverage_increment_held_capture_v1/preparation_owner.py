...
HERE=Path(__file__).resolve().parent;ROOT=HERE.parents[1];PREP=ROOT/'development/native_gate_coverage_increment_held_preparation_v1'
...
def main():
    ...
    try:
        ...
        require(text_lock['preparation_owner_binding']=={'namespace':'development/native_gate_coverage_increment_held_capture_v1','source_freeze_sha256':owner_sha},'OWNER_FIXED_BEFORE_TOKENIZATION')
