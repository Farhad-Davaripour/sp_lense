...
def capture(inputs,mode='success'):
    ...
    execution={'scope':'ROOT_APPROVED_NATIVE_CONSTRUCTION_CAPTURE_ONLY','attempt':'native_gate_coverage_increment_held_capture_attempt_001',
...
PREP=support.ROOT/'development/native_gate_coverage_increment_held_preparation_v1'
...
def fixture():
    cohort=copy.deepcopy(json.loads((support.ROOT/'development/native_gate_coverage_increment_v1/author_packet/EMPTY_SCHEMA.json').read_bytes())['HELD_SUBMISSION'])
