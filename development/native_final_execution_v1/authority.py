...
def read_release(approved):
    ...
    require(release['schema']=='native_final_execution_release.v1' and release['approved'] is True
...
def execution(release,approved):
    return {'scope':'ROOT_APPROVED_NATIVE_FINAL_ONLY','attempt':ATTEMPT,'release_sha256':approved,
