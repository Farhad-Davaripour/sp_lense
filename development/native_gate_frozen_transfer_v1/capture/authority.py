...
def read_release(approved):
    ...
    require(release['schema']=='frozen_transfer_capture_release.v1' and release['approved'] is True
...
def execution(release,approved):
    return {'scope':'ROOT_APPROVED_NATIVE_CONSTRUCTION_CAPTURE_ONLY','attempt':ATTEMPT,'release_sha256':approved,
        ...
        'held_submission_sha256':release['admitted_submission_sha256'],'role':'HELD_TRANSFER'}
def authenticate():
