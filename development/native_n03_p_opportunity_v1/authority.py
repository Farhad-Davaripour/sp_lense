...
LIMITS={'loads':1,'forwards':30,'derivatives':8,'encoding':0,'worker_seconds':600,'audit_seconds':60,'shared_cleanup_seconds':15,'total_bytes':48*1024**2,'file_bytes':5*1024**2}
...
def read_release(approved):
    ...
    require(release['schema']=='native_n03_p_opportunity_release.v1' and release['approved'] is True
