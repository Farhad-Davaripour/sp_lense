...
TRACE_PATH=ROOT/"development/gdn_public_smoke_v3/forward_trace.py"
TRACE_SHA="c592e0e00047d6fc991a1f5b21767df91a088a3640458ecf739fa5888b4fa781"
if hashlib.sha256(TRACE_PATH.read_bytes()).hexdigest()!=TRACE_SHA:raise RuntimeError("TRACE_SOURCE_CHANGED")
