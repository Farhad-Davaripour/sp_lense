...
def main():
    ...
    old=ROOT/'development/native_oracle_applicability_control_v1';previous=json.loads((old/'SOURCE_FREEZE.json').read_bytes())
    ...
    for name in (*previous['source_sha256'],'SOURCE_FREEZE.json','ROOT_CLOSEOUT_AND_NEXT_SCOPE.md','TEST_RESULTS.json','INDEPENDENT_REVIEW.md'):
        pin(old/name)
    ...
    lock={'schema':'native_oracle_family_panel_source_candidate.v1','real_authorized':False,
