...
ATTEMPT='native_oracle_family_panel_attempt_001'
def require(ok,code):
...
GROUP_CAPS={'logits':72*248320*4,'rows':72*128*1024,'traces':88*16*1024,'steps':16*32*1024,
...
def write_new(name,value,*,raw=False,critical=False):
    ...
    require(used+len(data)<=96*MIB-(0 if critical else 65536),'OUTPUT_CAP_CLOSEOUT_RESERVE')
