...
class Budget:
    def __init__(self,started):
        self.started=started;self.substantive_end=started+990;self.absolute_end=started+1005;self.used=0.;self.charges=[]
    @property
    ...
    def deadlines(self,now,lane):
        ...
        end=min(now+(900 if lane=='worker' else 90),self.substantive_end,self.absolute_end-self.remaining)
