...
CAPTURE=ROOT/'development/native_supervised_gate_capture_v1'
ATTEMPT='native_supervised_gate_capture_attempt_001'
MAX_FILE_BYTES=5*1024**2
CAPTURE_SOURCE_SHA256='6e72a485276a16be857a90fd370871419addadc0693e90f182f45835b9fc9ab5'
def keys():
...
def build_manifest(*,deadline=None):
    ...
    require(manifest['schema']=='native_supervised_gate_training_manifest_v2' and manifest['role']=='CONSTRUCTION'
        and manifest['feature_contract']==CONTRACT and manifest['namespace']=='development/native_supervised_gate_capture_v1'
        and manifest['attempt']==ATTEMPT and manifest['execution']==execution,'CONSTRUCTION_MANIFEST_SCOPE')
    selection=manifest['selection'];require(tuple(x['case'] for x in selection)==keys(),'EXACT32_FRESH_SELECTION')
